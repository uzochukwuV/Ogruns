...
func main() {
	...
	resp, err := http.Post("http://localhost:8080/api/v1/subscribers/webhook", "application/json", bytes.NewBuffer(webhookBytes))
	if err != nil {
	...
	resp2, err := http.Post("http://localhost:8080/api/v1/signals", "application/json", bytes.NewBuffer(submitBytes))
	if err != nil {
